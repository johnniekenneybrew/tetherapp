/* global React, ACCOUNTS, TODAY, fmtLong, fmtShort, fmtMD, addDays, MONTHS,
   Checkbox, AccountDot, StatusBadge, Icon, useState, useEffect, useRef, useMemo */

// ============================================================
// Social — Contacts page
// ============================================================

// Birthday helpers (top-level so all components can use them)
...
function SocialPage({ state, setState }) {
