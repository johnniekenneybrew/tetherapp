/* global React, ACCOUNTS, accLookup, TODAY, fmtShort, fmtMD, addDays, sameDay,
   Checkbox, AccountDot, Icon, useState, useEffect, useMemo */
...
function TodoList({ state, setState }) {
  ...
  // sort: overdue first, then priority, then by id
  ...
  return (
    <div className="page page--narrow fade-in">
      ...
      {/* Unified list: add row + incomplete + completed-today (in order) */}
      <div className="todo-list">
        {/* Add row — visually matches a task row */}
        ...
        {/* Incomplete then completed-today, no headers in between */}
